...
"        note:  used Anthony Carapetis's github.vim
...
"hi LineNr          guifg=#000000 guibg=#c7c7c7
hi LineNr           guifg=#A1A1A1   guibg=#E6E6E6

hi NonText          guifg=#808080   guibg=#ECECEC
"hi NonText      guifg=#EBEBEB                   " caracteres con set list
...
"hi SpecialKey   guifg=#EBEBEB               " caracteres con set list
hi SpecialKey       guifg=#808080   guibg=#ECECEC

"hi MatchParen       guibg=#FFFF99   guifg=#000000
...
" hi IncSearch        guibg=#FFFF99   guifg=#000000   gui=italic
" hi Search           guibg=#FFFF99   guifg=#000000   gui=italic
...
"hi Comment      guifg=#009933 gui=italic
hi Comment          guifg=#008A00   gui=italic
hi Constant         guifg=#177F80   gui=none
"hi String      guifg=#5f04b4
hi String           guifg=#9C2E9C
hi Function         guifg=#990000   gui=bold
"hi Statement   guifg=#000000 gui=bold,underline
hi Statement        guifg=#000000   gui=bold
"hi Type         guifg=#0066FF gui=bold
