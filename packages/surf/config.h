...
#define HOMEPAGE "http://joshaw.github.io/"
...
static SearchEngine searchengines[] = {
  ...
  { "en",       "http://dict.cc/?s=%s" },
  { "arch",     "https://wiki.archlinux.org/index.php?title=Special:Search&search=%s" },
  { "alt",      "http://alternativeto.net/SearchResult.aspx?search=%s" },
  { "yt",       "http://www.youtube.com/results?search_query=%s&oq=&gs_l=" },
  { "w",        "http://en.m.wikipedia.org/w/index.php?title=Special:Search&search=%s" },
